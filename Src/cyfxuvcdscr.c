...
#define UVC_VID	(0x03A4)
#define UVC_PID	(0x8776)

#define UVC_VID_LSB	(UVC_VID & 0x00FF)
#define UVC_VID_MSB ((UVC_VID & 0xFF00) >> 8)

#define UVC_PID_LSB	(UVC_PID & 0x00FF)
#define UVC_PID_MSG	((UVC_PID & 0xFF00) >> 8)
...
const uint8_t CyFxUSBDeviceDscr[] =
    {
        ...
        UVC_VID_LSB,UVC_VID_MSB,        /* Vendor ID */
        UVC_PID_LSB,UVC_PID_MSG,        /* Product ID */
...
const uint8_t CyFxUSBHSConfigDscr[] =
    {
       ...
       /* Class specific Uncompressed VS Frame descriptor */
        ...
        0xC1,0x03,                      /* Height in pixel 240-QVGA */
